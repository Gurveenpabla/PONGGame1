...
* 
* The GamePanel program makes the game functionable. 
* 
...
public class GamePanel extends JPanel implements Runnable{
    ...
    public void newPaddles() {
        paddle1 = new Paddle(0,0,4,GAME_HEIGHT,1);
    ...
    public void checkCollision() {      
        ...
        //resets the player score and creates new paddles & ball
        if (ball.x >= GAME_WIDTH-BALL_DIAMETER) {
            scoreList.add(score.player1);
            score.player1 = 0;
            newPaddles();
            newBall();
        }
